...
//        slidingTabLayout.setScrollBarSize(5);
        ...
        slidingTabLayout.setSelectedIndicatorColors(getResources().getColor(R.color.lime_green_A400));
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			 ...
			 * getResources().getString(R.string.main_section_0_title); case 1:
			 * return TermFinder.Term.values()[CURRENT_TERM_INDEX].name; case 2:
			 * return getResources().getString(R.string.main_section_2_title);
			 * case 3: return
			 * getResources().getString(R.string.main_section_3_title); default:
			 * return ""; }
			 */
		}
